...
네 핵심 비교와 추가 bucket 진단에 사용된 최소 데이터 사본이다.
...
- `03_nostream_vs_stream16`: no-stream 3회와 optimized 16 MiB overlap 3회
...
`overlap_h2d_with_cpu_update=false`인 실험이다. 따라서 overlap-enabled 16 MiB
